        ...
        return (
            ...
            <div className="container">
                ...
                <form >
                    ...
                    <div className="form-group">
                        <label>Email</label>
                        <input type="email" id='TeachEmail' className="form-control" placeholder='Enteryouremail'/>
                    </div>
                    <div className="form-group">
                        <label>PhoneNumber</label>
                        <input type="tel" id="Teacherphone" className="form-control" placeholder='EnderyourNumber' />
                    </div>
                    <div className="form-group">
